...
const FIXTURE = join(__dirname, "fixtures", "priya-paper.md");
...
describe("Priya the Researcher: launch-smoke", () => {
  it("opens her paper fixture and the app launches cleanly", async () => {
